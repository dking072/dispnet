...
class DispNet(L.LightningModule):
    def __init__(self,representation,nc=1,freeze=True,anisotropy=False):
        ...
        self.register_buffer('e_bias',torch.tensor(0.2)) #Ha
    ...
    def forward(self,data,training=False,calc_force=True,calc_adiv=False):
        ...
        data["dyad_tr"] = data["dyad_tr"] * data["e"] #Multiply by E now
        ...
        num = dyad
        denom_1 = data["e"] #Multiplier on the denom (min 1/100)
        denom = denom_1[:,:,None,None,None] + self.zeta[None,None,None,None,:]**2 #(N,C,3,3,G)
